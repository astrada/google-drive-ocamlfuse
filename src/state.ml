...
let of_table table =
  ...
  { auth_request_id =
      get "auth_request_id" Std.identity empty.auth_request_id;
    auth_request_date =
      get "auth_request_date" GapiDate.of_string empty.auth_request_date;
    refresh_token =
      get "refresh_token" Std.identity empty.refresh_token;
    last_access_token =
    ...
    saved_version =
      get "saved_version" Std.identity empty.saved_version;
  }
