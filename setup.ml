...
(* OASIS_START *)
(* DO NOT EDIT (digest: bac8c887cd45100dd2f03c4479438856) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("gapi-ocaml",
                               Some (OASISVersion.VGreaterEqual "0.3.5"));
     ...
     oasis_digest = Some "\142\b\194\230r8\240\233u\028X\222\246\213\227]";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
