...
(* OASIS_START *)
(* DO NOT EDIT (digest: 29cea3f1405155e5f96990c6309c56a7) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build for OPAM package manager";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\028\150\191\225~\005-\011f\169\017Wt\020ud";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
