...
(* OASIS_START *)
(* DO NOT EDIT (digest: bd6a176ceb891e8feca42a6041f79d19) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("gapi-ocaml",
                               Some (OASISVersion.VGreaterEqual "0.2.7"));
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\152U\212\145\250N\182\153\222\170f\187k\134Bn";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
